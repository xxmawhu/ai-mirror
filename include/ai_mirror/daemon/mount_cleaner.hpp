...
// - find_stale_mounts() matches mount source paths exactly using
// /proc/self/mountinfo
// - cleanup_for_user() validates mount point path starts with exact user home
// prefix
//   (e.g., /home/imaxx_alpha exactly, not matching
//   /home/imaxx_alpha_other_project)
