...
large_float_pi = 3.1415926535897932384626433832795028842
  ...
  std::cout << "large_int_dec  = " << input.at("large_int_dec").as_integer()
            << std::endl;
  std::cout << "large_int_hex  = " << input.at("large_int_hex").as_integer()
            << std::endl;
  std::cout << "large_float_pi = "
            << std::setprecision(
                   std::numeric_limits<
                       boost::multiprecision::cpp_bin_float_oct>::max_digits10 -
                   1)
