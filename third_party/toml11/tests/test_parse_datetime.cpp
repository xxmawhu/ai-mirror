...
TEST_CASE("testing offset_datetime") {
  const auto fmt = [](toml::datetime_delimiter_kind d, bool has_sec,
                      std::size_t prec) {
...
TEST_CASE("testing local_datetime") {
...

  {
    ...
    toml11_test_parse_success<toml::value_t::local_datetime>(
        "1979-05-27T07:32:00",
        toml::local_datetime(toml::local_date(1979, toml::month_t::May, 27),
                             toml::local_time(7, 32, 0)),
        comments(), fmt(toml::datetime_delimiter_kind::upper_T, true, 0), ctx);
...
TEST_CASE("testing local_date") {
  ...
  toml11_test_parse_success<toml::value_t::local_date>(
      "1979-05-27", toml::local_date(1979, toml::month_t::May, 27), comments(),
      toml::local_date_format_info{}, ctx);
  toml11_test_parse_success<toml::value_t::local_date>(
      "0979-12-27", toml::local_date(979, toml::month_t::Dec, 27), comments(),
      toml::local_date_format_info{}, ctx);

  toml11_test_parse_failure(toml::detail::parse_local_date<toml::type_config>,
                            "1979-00-27", ctx);
  toml11_test_parse_failure(toml::detail::parse_local_date<toml::type_config>,
                            "1979-13-27", ctx);
  toml11_test_parse_failure(toml::detail::parse_local_date<toml::type_config>,
...
TEST_CASE("testing local_time") {
  ...
  };
  {
    ...
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:02:03", toml::local_time(1, 2, 3), comments(), fmt(true, 0), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45", toml::local_time(1, 23, 45), comments(), fmt(true, 0), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45.1", toml::local_time(1, 23, 45, 100), comments(),
        fmt(true, 1), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45.12", toml::local_time(1, 23, 45, 120), comments(),
        fmt(true, 2), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45.123", toml::local_time(1, 23, 45, 123), comments(),
        fmt(true, 3), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45.1234", toml::local_time(1, 23, 45, 123, 400), comments(),
        fmt(true, 4), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45.1234567", toml::local_time(1, 23, 45, 123, 456, 700),
        comments(), fmt(true, 7), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45.123456789", toml::local_time(1, 23, 45, 123, 456, 789),
        comments(), fmt(true, 9), ctx);
  }

  {
    ...
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23", toml::local_time(1, 23, 0), comments(), fmt(false, 0), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:02", toml::local_time(1, 2, 0), comments(), fmt(false, 0), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:02:03", toml::local_time(1, 2, 3), comments(), fmt(true, 0), ctx);
    toml11_test_parse_success<toml::value_t::local_time>(
        "01:23:45", toml::local_time(1, 23, 45), comments(), fmt(true, 0), ctx);
