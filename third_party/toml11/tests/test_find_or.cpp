...
TEST_CASE("testing find_or; converting to a map") {
  ...
  {
    const toml::value v1 = toml::table{{"key", toml::table{{"key", "value"}}}};
  ...
  {
    toml::value v1 = toml::table{{"key", toml::table{{"key", "value"}}}};
...
TEST_CASE("testing find_or(val, keys..., opt)") {
  // &, using type deduction
  {
    toml::value v(toml::table{
        {"foo", toml::table{{"bar", toml::table{{"baz", "qux"}}}}}});
    std::string opt("hoge");
  ...
  {
    const toml::value v(
        toml::table{{"foo", toml::table{{"bar", toml::table{{"baz", 42}}}}}});
    int opt = 6 * 9;
              ...
              toml::table{
                  {"C", toml::table{
                            {"D", toml::table{
                                      {"E", toml::table{{"F", 42}}}}}}}}}}}});
    auto v1 =
        toml::find_or<std::string>(v, "A", "B", "C", "D", "E", "F", "bar");
