...
TEST_CASE("testing custom error message using source_location") {
  ...
  const auto err = toml::make_error_info(
      "val not in range", lower.location(), "lower limit is defined here",
      upper.location(), "upper limit is defined here", val.location(),
      "this is not in the range", "Hint: upper limit is inclusive");
...
TEST_CASE("testing custom error message using value") {
  ...
  const auto err = toml::make_error_info(
      "val not in range", lower, "lower limit is defined here", upper,
      "upper limit is defined here", val, "this is not in the range",
...
TEST_CASE("testing custom error message using source_location and value") {
  ...
  const auto err = toml::make_error_info(
      "val not in range", lower, "lower limit is defined here", upper,
      "upper limit is defined here", val.location(), "this is not in the range",
      "Hint: upper limit is inclusive");
