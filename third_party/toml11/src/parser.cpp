...
template result<basic_value<type_config>, std::vector<error_info>>
...
template basic_value<type_config> parse<type_config>(std::vector<unsigned char>,
                                                     std::string, spec);
template basic_value<type_config> parse<type_config>(std::istream &,
                                                     std::string, spec);
...
template basic_value<type_config> parse_str<type_config>(std::string, spec,
                                                         cxx::source_location);

template result<basic_value<ordered_type_config>, std::vector<error_info>>
...
template basic_value<ordered_type_config>
